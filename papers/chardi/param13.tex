...
\begin{equation}
  ...
  \cA(\bq_l)\right]^2,
\end{equation}
where $\hat{\bs{\theta}}=()$ \textbf{[WHAT is $\hat{\bs{\theta}}$]}
and $\cA(\bq_l)$ is given by Eqs.~\eqref{isotropic},
\eqref{singletensor} or~\eqref{doubletensor}.  This however does not
allow us to easily chose between the models of Eqs.~\eqref{isotropic},
